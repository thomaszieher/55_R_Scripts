...
for (depth in depths$depth){
  ...
  plot(depthData$seconds,depthData$resDiff,type="p",ylim=c(-40,0),ylab="Resistivity difference [Ohm m]",xlab="Time [s]",las=1)
  ...
  plot(NA,NA,xlim=c(30,45),ylim=c(0,-40),ylab="Resistivity difference [Ohm m]",xlab="Soil moisture [Vol%]",las=1)
