...
maxdate=as.POSIXct(strptime("2014-07-24 19:30:00",format="%Y-%m-%d %H:%M:%S"))
...
TDRafter=subset(dataProbes,(dataProbes[,2]>=as.POSIXct(measureday)+(15*60*60))&(dataProbes[,2]<=as.POSIXct(measureday)+(20*60*60)))[seq(1,ncol(dataProbes),by=3)]
#boxplot(TDRafter)
