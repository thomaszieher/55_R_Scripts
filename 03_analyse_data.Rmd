...
##extrapolate initial soil moisture
TDRexp=data.frame(depth=seq(0,100,10),volexp=predict(lm(vol~depth,data=TDRdata),newdata=data.frame(depth=seq(0,100,10))))
...
mtext(side=2,"Depth [m]",line=2.5,las=0)
mtext(side=4,line=5,"Pressure head [m]",las=0)
plot(data.r,col=rev(colors),zlim=c(zMin,zMax),add=T)
```
